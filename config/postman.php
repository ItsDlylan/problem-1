...
return [
    ...
    */
    'auth' => [
        ...
        'default' => [
            'token' => env('POSTMAN_AUTH_TOKEN', 'your-access-token'),       // For bearer auth
            'username' => env('POSTMAN_AUTH_USER', 'user@example.com'),      // For basic auth
            'password' => env('POSTMAN_AUTH_PASSWORD', 'password'),          // For basic auth
            'key_name' => env('POSTMAN_API_KEY_NAME', 'X-API-KEY'),          // For api_key auth
            'key_value' => env('POSTMAN_API_KEY', 'your-api-key-here'),      // For api_key auth
        ],
